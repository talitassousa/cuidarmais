...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando unico médio cadastrado não está disponivel na data")
    void DevolverNullMedicoAleatorioNaoEstaLivreNaData() {
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);

        var medico = cadastrarMedico("Medico", "medico@cuidar.mmais", "123456", Especialidade.CARDIOLOGIA);
    ...
    void escolherMedicoAleatorioLivreNaData() {
        ...
        var medico = cadastrarMedico("Medico", "medico@cuidar.mais", "123456", Especialidade.CARDIOLOGIA);
